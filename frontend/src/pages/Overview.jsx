...
export default function Overview() {
  ...
  // Friendly onboarding for a brand-new account with nothing yet.
  if (summary.totalProducts === 0) {
    return (
      <div className="container wide">
        <h1>Welcome to ComplyCRA 👋</h1>
        <p className="muted">Let's get your first product on the path to CRA compliance. It takes a few minutes.</p>
        <div className="card" style={{ background: 'linear-gradient(135deg,#eff6ff,#ffffff)' }}>
          <h2>Get started in 3 steps</h2>
          <ol style={{ lineHeight: 1.9, paddingLeft: 20 }}>
            <li><strong>Classify a product</strong> — answer a few questions to find scope &amp; risk class.</li>
            <li><strong>Self-assess against Annex I</strong> — see exactly what to fix, with a readiness score.</li>
            <li><strong>Track &amp; report</strong> — SBOM scanning, support periods and approval-gated reporting.</li>
          </ol>
          <div className="btn-row">
            <Link className="btn" to="/">Classify your first product →</Link>
            <Link className="btn secondary" to="/cvd-policy">Set up your CVD policy</Link>
          </div>
        </div>
        <div className="card">
          <strong>💡 Tip:</strong> <span className="muted">Your Coordinated Vulnerability Disclosure (CVD) policy is set once for the whole company and counts toward every product's coverage — a quick early win.</span>
        </div>
      </div>
    );
  }
